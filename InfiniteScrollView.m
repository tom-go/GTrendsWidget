...
- (CGFloat)placeNewLabelOnRight:(CGFloat)rightEdge {
	...
	[_visibleItems addObject:itemView]; // add rightmost label at the end of the array
...
- (CGFloat)placeNewLabelOnLeft:(CGFloat)leftEdge {
	...
	[_visibleItems insertObject:itemView atIndex:0]; // add leftmost label at the beginning of the array
